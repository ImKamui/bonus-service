# bonus-service
<h2>Этапы</h2>
Все этапы распределены по веткам - Stage-1, Stage-2, Stage-3 и Stage-4 соответственно. В ветке main находится только информация об API
<h2>Тесты</h2>
Все тесты проводились на этом сайте: https://reqbin.com
<h2>База данных</h2>
...
<h2>Example (пошаговая инструкция)</h2>
...
/api/cards/refund-bonus - вернуть бонусы в случае возврата товара. Работает аналогично up-balance, но срабатывает только при условии возврата товара.<br/>
<br/>
<h2>Миграция БД</h2>
